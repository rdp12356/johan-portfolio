...
import { skills as defaultSkills } from '../data/content'
...
function Skills() {
  const dynamicSkills = defaultSkills
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div className="max-w-2xl">
            <SectionTitle
              ...
              description="A curated collection of my technical expertise and specialized tools."
            />
          </div>
        </div>
